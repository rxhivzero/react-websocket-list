...
const config = {
  ...
  entry: {
    app: ['./main.js', './assets/scss/main.scss',],
    vendor: ['react', 'react-dom', 'react-router', 'react-redux', 'redux', 'redux-thunk' , 'axios']
  },
  ...
  plugins: [
    ...
    new ExtractTextPlugin({ filename: './styles/style.[chunkhash].css', disable: false, allChunks: true }),
